...
urlpatterns = [
     ...
     path('upload/filiacao/', views.upload_pdf_base, {'automacao': 'filiacao'}, name='upload_pdf_filiacao'),
     path('upload/atividade-pesqueira/', views.upload_pdf_base, {'automacao': 'atividade_pesqueira'}, name='upload_pdf_atividade_pesqueira'),
     path('upload/hipossuficiencia/', views.upload_pdf_base, {'automacao': 'hipossuficiencia'}, name='upload_pdf_hipossuficiencia'),
     path('upload/procuracao-juridica/', views.upload_pdf_base, {'automacao': 'procuracao_juridica'}, name='upload_pdf_procuracao_juridica'),
     path('upload/recibo-anuidade/', views.upload_pdf_base, {'automacao': 'recibos_anuidades'}, name='upload_pdf_recibo_anuidade'),
