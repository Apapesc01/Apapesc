...
TIPOS_DOCS = [
    ...
    ("0010_CTPS_Cart_Trabalho", "Carteira de Trabalho e Previdência Social."),
    ("0011_Declaração_Residência_MAPA", "Declaração de residência para o MAPA."),
    ("0012_Ficha_Req_Filiação_ASS_PRESID_JUR", "Ficha de filiação assinada pelo presidente ou jurídico."),
    ("0013_Ficha_Req_Filiação_ASS_Associado", "Ficha de filiação do associado."),
    ("0014_Foto_3x4", "Foto 3x4 do associado."),
    ("0015_Licença_Embarcação", "Licença de embarcação."),
    ("0016_NIT_Extrato", "Extrato do Número de Identificação do Trabalhador."),
    ("0017_Procuração_AD_JUDICIA", "Procuração para advogado/judicial."),
    ("0018_Procuracao_ADMINISTRATIVA", "Procuração administrativa."),
    ("0019_Protocolo_ENTRADA_RGP", "Protocolo de entrada do RGP."),
    ("0020_RG_Identidade_CIN", "RG (Carteira de Identidade Nacional)."),
    ("0021_RGP_Cart_Pescador", "Carteira RGP do pescador."),
    ("0021_TIE_Titulo_Embarcação", "Título de Embarcação (TIE)."),
    ("0022_Titulo_Eleitor", "Título de Eleitor do associado."),
]
